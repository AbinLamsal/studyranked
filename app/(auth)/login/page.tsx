          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                className="w-full bg-studyrank-card border border-studyrank-border rounded-md px-4 py-3 text-studyrank-primary placeholder-studyrank-muted text-sm focus:outline-none focus:border-studyrank-purple transition-colors"
              />
            </div>
